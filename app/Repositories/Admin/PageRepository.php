    ...
    public function updateCustomPage(Request $request, Page $page, SettingRepository $settingRepository): void
    {
        if ($page->slug == '/'){
            ...
            $page->update([
                ...
                'breadcrumb_bg_type' => $request->breadcrumb_bg_type ?? 'image',
                'breadcrumb_bg_image' => $request->breadcrumb_bg_image,
                'breadcrumb_bg_color' => $request->breadcrumb_bg_color ?? '#000000',
