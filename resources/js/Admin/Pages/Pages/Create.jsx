...
import {
    ...
    updatePageFunFactSection,
    updatePageHeroSection,
    updatePageMovingTextSection,
    updatePagePartnerSection, updatePagePhotoGallerySection,
    updatePagePortfolioSection,
    updatePagePricingSection, updatePageResumeSection,
    updatePageSection,
    updatePageSectionFaqPage,
    updatePageServiceSection,
...
import {
    ...
    updateHomePhotoGallerySection, updateHomeResumeSection, updateHomeTestimonialSection,
...
export default function Create() {
    ...
    const handleUpdateSpacing = (e) => {
        let customizeSpacing = JSON.parse(JSON.stringify(page.sections));
        ...
        dispatch(updatePageSection(customizeSpacing));
    };

    const updateHeroSection = (data) => {
        dispatch(updatePageHeroSection(data));
    };
    const updateFunFactSection = (data) => {
        dispatch(updatePageFunFactSection(data));
    };
    const updateServiceSection = (data) => {
        dispatch(updatePageServiceSection(data));
    };
    const updatePortfolioSection = (data) => {
        dispatch(updatePagePortfolioSection(data));
    };
    const updateAwardSection = (data) => {
        dispatch(updatePageAwardSection(data));
    };
    const updateVideoSection = (data) => {
        dispatch(updatePageVideoSection(data));
    };
    const updateTeamSection = (data) => {
        dispatch(updatePageTeamSection(data));
    };
    ...
    const updatePartnerSection = (data) => {
        dispatch(updatePagePartnerSection(data));
    };
    const updateCTASection = (data) => {
        dispatch(updatePageCTASection(data));
    };
    const updatePricingSection = (data) => {
        dispatch(updatePagePricingSection(data));
    };
    const updateContactSection = (data) => {
        dispatch(updatePageContactSection(data));
    };
    const updateCaseStudySection = (data) => {
        dispatch(updatePageCaseStudySection(data));
    };
    const updateAboutSectionData = (data) => {
        dispatch(updatePageAboutSection(data));
    };
    const updateWhyChooseUsSection = (data) => {
        dispatch(updatePageWhyChooseUsSection(data));
    };
    const updateFaqSection = (data) => {
        dispatch(updatePageSectionFaqPage(data));
    };
    const updateTestimonialSection = (data) => {
        dispatch(updatePageTestimonialSection(data))
    };
    const updatePhotoGallerySection = (data) => {
        dispatch(updatePagePhotoGallerySection(data))
    };
    const updateWorkingProgressSection = (data) => {
        dispatch(updatePageWorkingProgressSection(data))
    };
    const updateBannerSection = (data) => {
        dispatch(updatePageBannerSection(data))
    };
        ...
        case "Hero":
            customizeSection = (
                <HeroSectionCustomize
                    ...
                    sectionData={page.sections_data.hero_section}
                />
            );
            break;
        case "FunFact":
            customizeSection = (
                <FunFactSectionCustomize
                    ...
                    sectionData={page.sections_data.our_fun_fact_section}
                />
            );
            break;
        case "Service":
            customizeSection = (
                <ServiceCustomize
                    ...
                    sectionData={page.sections_data.service_section}
                />
            );
            break;
        case "Portfolio":
            customizeSection = (
                <PortfolioCustomize
                    ...
                    sectionData={page.sections_data.portfolio_section}
                />
            );
            break;
        case "Award":
            customizeSection = (
                <AwardCustomize
                    ...
                    sectionData={page.sections_data.award_section}
                />
            );
            break;
        case "Video":
            customizeSection = (
                <VideoCustomize
                    ...
                    sectionData={page.sections_data.video_section}
                />
            );
            break;
        case "Team":
            customizeSection = (
                <TeamCustomize
                    ...
                    sectionData={page.sections_data.our_team_section}
                />
            );
            break;
        case "Blog":
        ...
        case "MovingText":
            customizeSection = (
                <MovingTextCustomize
                    ...
                    sectionData={page.sections_data.moving_text_section}
                />
            );
            break;
        case "Partner":
            customizeSection = (
                <PartnerCustomize
                    ...
                    sectionData={page.sections_data.partner_section}
                />
            );
            break;
        case "CTA":
            customizeSection = (
                <CTACustomize
                    ...
                    sectionData={page.sections_data.cta_section}
                />
            );
            break;
        case "Pricing":
            customizeSection = (
                <PricingCustomize
                    ...
                    sectionData={page.sections_data.pricing_section}
                />
            );
            break;
        case "Contact":
            customizeSection = (
                <ContactCustomize
                    ...
                    sectionData={page.sections_data.contact_section}
                />
            );
            break;
        case "CaseStudy":
            customizeSection = (
                <CaseStudyCustomize
                    ...
                    sectionData={page.sections_data.case_study_section}
                />
            );
            break;
        case "About":
            customizeSection = (
                <AboutCustomize
                    ...
                    sectionData={page.sections_data.about_section}
                />
            );
            break;
        case "WhyChooseUs":
            customizeSection = (
                <WhyCooseUsCustomize
                    ...
                    sectionData={page.sections_data.why_choose_us}
                />
            );
            break;
        case "Faq":
            customizeSection = (
                <FaqCustomize
                    ...
                    sectionData={page.sections_data.faq_section}
                />
            );
            break;
        case "Testimonial":
            customizeSection = (
                <TestimonialCustomize
                    ...
                    sectionData={page.sections_data.testimonial_section}
                />
            );
            break;
        case "PhotoGallery":
            customizeSection = (
                <PhotoGalleryCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={page.sections_data.photo_gallery_section}
        ...
        case "WorkingProgress":
            customizeSection = (
                <WorkingProgressCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={page.sections_data.working_progress_section}
        ...
        case "Banner":
            customizeSection = (
                <BannerCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={page.sections_data.banner_section}
        ...
        case "Resume":
            customizeSection = (
                <ResumeCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={page.sections_data.resume_section}
    ...
    // handle publish
    const handlePublish = () => {
        router.post(route("admin.pages.store"), page);
    };

    // update section to state
    useEffect(() => {
        dispatch(updatePageSection(customizeSections));
    }, [customizeSections]);

    // if have any validation error than open customize section
    useEffect(() => {
        if (Object.keys(errors).length !== 0) {
            setExpandCustomize("PageDetails");
            setIsOpen(true);
        }
    }, [errors]);
                ...
                <div className="customize-section-area">
                    ...
                    <div className="customize-sections">
                        <div
                            ...
                            onClick={() => handleExpand("PageDetails")}
                        >
