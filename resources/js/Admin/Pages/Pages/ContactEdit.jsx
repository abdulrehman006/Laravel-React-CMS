...
import ContactPageCustomize from "@/Admin/Components/PageCustomize/ContactPageCustomize";
import {
    ...
    updateContactFunFactSection,
    updateContactHeroSection,
    updateContactMovingTextSection,
    updateContactPartnerSection, updateContactPhotoGallerySection,
    updateContactPortfolioSection,
    updateContactPricingSection, updateContactResumeSection,
    updateContactSection,
    updateContactServiceSection,
    updateContactTeamSection, updateContactTestimonialSection,
    updateContactVideoSection,
    updateContactWhyChooseUsSection, updateContactWorkingProgressSection,
...
export default function AboutEdit() {
    ...
    const contact = useSelector((state) => state.contactPage);
    const dispatch = useDispatch();
    const dragItem = useRef(null);
    const dragOverItem = useRef(null);
    const [isExpandInfo, setIsExpandInfo] = useState(false);
    const [isOpen, setIsOpen] = useState(true);
    const [expandCustomize, setExpandCustomize] = useState("ContactDetails");
    const [customizeSections, setCustomizeSections] = useState([]);
    const [isAddSection, setIsAddSection] = useState(false);
    const [sectionIndex, setSectionIndex] = useState("");

    const currentSection = contact.sections[sectionIndex];
    ...
    const updateHeroSection = (data) => {
        dispatch(updateContactHeroSection(data));
    };
    const updateFunFactSection = (data) => {
        dispatch(updateContactFunFactSection(data));
    };
    const updateServiceSection = (data) => {
        dispatch(updateContactServiceSection(data));
    };
    const updatePortfolioSection = (data) => {
        dispatch(updateContactPortfolioSection(data));
    };
    const updateAwardSection = (data) => {
        dispatch(updateContactAwardSection(data));
    };
    const updateVideoSection = (data) => {
        dispatch(updateContactVideoSection(data));
    };
    const updateTeamSection = (data) => {
        dispatch(updateContactTeamSection(data));
    };
    ...
    const updatePartnerSection = (data) => {
        dispatch(updateContactPartnerSection(data));
    };
    const updateCTASection = (data) => {
        dispatch(updateContactCTASection(data));
    };
    const updatePricingSection = (data) => {
        dispatch(updateContactPricingSection(data));
    };
    const updateContactSectionData = (data) => {
        dispatch(updateContactContactSection(data));
    };
    const updateCaseStudySection = (data) => {
        dispatch(updateContactCaseStudySection(data));
    };
    const updateAboutSection = (data) => {
        dispatch(updateContactAboutSection(data));
    };
    const updateWhyChooseUsSection = (data) => {
        dispatch(updateContactWhyChooseUsSection(data));
    };
    const updateFaqSection = (data) => {
        dispatch(updateContactFaqSection(data));
    };
    const updateTestimonialSection = (data) => {
        dispatch(updateContactTestimonialSection(data))
    };
    const updatePhotoGallerySection = (data) => {
        dispatch(updateContactPhotoGallerySection(data))
    };
    const updateWorkingProgressSection = (data) => {
        dispatch(updateContactWorkingProgressSection(data))
    };
    const updateBannerSection = (data) => {
        dispatch(updateContactBannerSection(data))
    };
    const updateResumeSection = (data) => {
        dispatch(updateContactResumeSection(data))
    }

    const handleUpdateSpacing = (e) => {
        let customizeSpacing = JSON.parse(JSON.stringify(contact.sections));
        ...
        dispatch(updateContactSection(customizeSpacing));
    };
        ...
        case "Hero":
            customizeSection = (
                <HeroSectionCustomize
                    ...
                    sectionData={contact.sections_data.hero_section}
                />
            );
            break;
        case "FunFact":
            customizeSection = (
                <FunFactSectionCustomize
                    ...
                    sectionData={contact.sections_data.our_fun_fact_section}
                />
            );
            break;
        case "Service":
            customizeSection = (
                <ServiceCustomize
                    ...
                    sectionData={contact.sections_data.service_section}
                />
            );
            break;
        case "Portfolio":
            customizeSection = (
                <PortfolioCustomize
                    ...
                    sectionData={contact.sections_data.portfolio_section}
                />
            );
            break;
        case "Award":
            customizeSection = (
                <AwardCustomize
                    ...
                    sectionData={contact.sections_data.award_section}
                />
            );
            break;
        case "Video":
            customizeSection = (
                <VideoCustomize
                    ...
                    sectionData={contact.sections_data.video_section}
                />
            );
            break;
        case "Team":
            customizeSection = (
                <TeamCustomize
                    ...
                    sectionData={contact.sections_data.our_team_section}
                />
            );
            break;
        case "Blog":
        ...
        case "MovingText":
            customizeSection = (
                <MovingTextCustomize
                    ...
                    sectionData={contact.sections_data.moving_text_section}
                />
            );
            break;
        case "Partner":
            customizeSection = (
                <PartnerCustomize
                    ...
                    sectionData={contact.sections_data.partner_section}
                />
            );
            break;
        case "CTA":
            customizeSection = (
                <CTACustomize
                    ...
                    sectionData={contact.sections_data.cta_section}
                />
            );
            break;
        case "Pricing":
            customizeSection = (
                <PricingCustomize
                    ...
                    sectionData={contact.sections_data.pricing_section}
                />
            );
            break;
        case "Contact":
            customizeSection = (
                <ContactCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    updateContactSection={updateContactSectionData}
                    sectionData={contact.sections_data.contact_section}
                />
            );
            break;
        case "CaseStudy":
            customizeSection = (
                <CaseStudyCustomize
                    ...
                    sectionData={contact.sections_data.case_study_section}
                />
            );
            break;
        case "About":
            customizeSection = (
                <AboutCustomize
                    ...
                    sectionData={contact.sections_data.about_section}
                />
            );
            break;
        case "WhyChooseUs":
            customizeSection = (
                <WhyCooseUsCustomize
                    ...
                    sectionData={contact.sections_data.why_choose_us}
                />
            );
            break;
        case "Faq":
            customizeSection = (
                <FaqCustomize
                    ...
                    sectionData={contact.sections_data.faq_section}
                />
            );
            break;
        case "Testimonial":
            customizeSection = (
                <TestimonialCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={contact.sections_data.testimonial_section}
                    updatePhotoGallerySection={updateTestimonialSection}
                />
            );
            break;
        ...
        case "PhotoGallery":
            customizeSection = (
                <PhotoGalleryCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={contact.sections_data.photo_gallery_section}
        ...
        case "WorkingProgress":
            customizeSection = (
                <WorkingProgressCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={contact.sections_data.working_progress_section}
        ...
        case "Banner":
            customizeSection = (
                <BannerCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={contact.sections_data.banner_section}
        ...
        case "Resume":
            customizeSection = (
                <ResumeCustomize
                    currentSection={currentSection}
                    spacingCallback={handleUpdateSpacing}
                    sectionData={contact.sections_data.resume_section}
    ...
    // handle publish
    const handlePublish = () => {
        router.post(route("admin.pages.update", contactData), { _method: 'put', ...contact });
    };

    // handle set state
    useEffect(() => {
        setCustomizeSections(contactData.sections);
    }, [contactData]);

    // update section to state
    useEffect(() => {
        dispatch(updateContactSection(customizeSections));
    }, [customizeSections]);

    // if have any validation error than open customize section
    useEffect(() => {
        if (Object.keys(errors).length !== 0) {
            setExpandCustomize("ContactDetails");
            setIsOpen(true);
        }
    }, [errors]);

    return (
        <PageCustomizeLayout type="contact">
                ...
                <div className="customize-section-area">
                    ...
                    <div className="customize-sections">
                        <div
                            ...
                            onClick={() => handleExpand("ContactDetails")}
                        >
