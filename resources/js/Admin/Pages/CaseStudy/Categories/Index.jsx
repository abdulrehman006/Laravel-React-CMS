...
export default function Index({ categories, sort }) {
    ...
    const getResults = (search) => {
        router.get(
            route("admin.case.study.categories.index", {
    ...
    const handleBulkAction = () => {
        ...
        if (selectedOption === "Delete") {
            confirmMessage = "You want to delete selected categories?";
            action = "admin.case.study.categories.bulk.delete";
        }
        setIsMarkAll([]);
            ...
            <AdminLayouts>
                ...
                <div className="container-fluid">
                    <div className="yoo-uikits-heading">
                        <h2 className="yoo-uikits-title">All Categories</h2>
                    </div>
                                ...
                                <div className="yooDataTableWrap">
                                    <div className="dataTables_heading">
                                        ...
                                        <div className="dataTables_heading_right">
                                            ...
                                            {hasPermission(
                                                "case_study_categories.create"
                                            ) && (
                                                <Link
                                                    href={route(
                                                        "admin.case.study.categories.create"
                                                    )}
                                                    ...
                                                    (category, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td>
                                                                ...
                                                                >
                                                                    {hasPermission(
                                                                        "case_study_categories.edit"
                                                                    ) && (
                                                                        <Link
                                                                            href={route(
                                                                                "admin.case.study.categories.edit",
                                                                                category
                                                                            )}
                                                                    ...
                                                                    {hasPermission(
                                                                        "case_study_categories.delete"
                                                                    ) && (
                                                                        <DeleteButton
                                                                            href={route(
                                                                                "admin.case.study.categories.destroy",
                                                                                category
                                                                            )}
                                                                        />
                                                                    )}
