...
export const caseStudySlice = createSlice({
    ...
    reducers: {
        updateCaseStudyDetails(state, action){
            state.case_study_details = action.payload;
        },
...
export const {updateCaseStudyDetails, updateCaseStudySection, updateCaseStudyWhyChooseUsSection, updateCaseStudyMovingTextSection, updateCaseStudyFunFactSection, updateCaseStudyCaseStudySection, updateCaseStudyPortfolioSection, updateCaseStudyContactSection, updateCaseStudyServiceSection, updateCaseStudyPricingSection, updateCaseStudyPartnerSection, updateCaseStudyFaqSection, updateCaseStudyCTASection, updateCaseStudyTeamSection, updateCaseStudyVideoSection, updateCaseStudyBlogSection, updateCaseStudyAwardSection, updateCaseStudyAboutSection, updateCaseStudySectionsData, updateCaseStudyHeroSection, updateCaseStudyWorkingProgressSection, updateCaseStudyPhotoGallerySection, updateCaseStudyTestimonialSection, updateCaseStudyResumeSection, updateCaseStudyBannerSection} = caseStudySlice.actions
